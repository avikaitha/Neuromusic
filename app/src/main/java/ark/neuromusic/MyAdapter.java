...
/**
 * Created by akaitha on 4/14/2016.
 */
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    private String profile_pic;        //int Resource for header view profile picture
    ...
    MyAdapter(String Titles[], int Icons[], String Name, String Email, String Profile, Context passedContext){ // MyAdapter Constructor with titles and icons parameter
        ...
        name = Name;
        email = Email;
        profile_pic = Profile;                     //here we assign those passed values to the values we declared here
    ...
    public void onBindViewHolder(MyAdapter.ViewHolder holder, int position) {
        if(holder.Holderid ==1) {                              // as the list view is going to be called after the header view so we decrement the
            ...
            Picasso.with(this.context)
                    .load(profile_pic)
                    .placeholder(this.context.getResources().getDrawable(R.drawable.placeholder_track_drawable))
                    .into(holder.profile);
